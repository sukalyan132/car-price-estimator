...
$admn_details=$user->select_for_prticular_row_all('admin_table','type','subAdmin');
///////////////////////////////////////////////////////////////
if(isset($_POST['submit']))
{
	$mess=$user->create_sub_admin_profile($_POST);
	//exit();
    if($mess=='true')
    {
    ?>
    <script type="text/javascript">
        ...
        window.location="create_subadmin.php";
    </script>
    <?php
    }
    else
    {
        ?>
        <script type="text/javascript">
        alert("Admin name already in use.");
        window.location="create_subadmin.php";
    </script>
        <?php
    }
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i>Create SubAdmin</h2>
...
<div class="row">
    ...
    <div class="box-content">
        <table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
            ...
            <?php 
            $i=1;
                while($row=mysql_fetch_array($admn_details))
                {
            ...
            ?>
                <tr>
                    ...
                    <td class="center">
                       <a href="setting.php?id=<?php echo $row['id'];?>"> <button type="button" class="btn btn-info">Info</button></a>
                    </td>
                </tr>
